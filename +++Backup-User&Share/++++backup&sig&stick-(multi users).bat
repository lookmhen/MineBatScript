...
echo d | xcopy "C:\Users\%%A\*" "d:\++Bkuser\%%A" /k /o /s /e
echo d | xcopy C:\Users\%%A\AppData\Roaming\Microsoft\Signatures\* "d:\++Bkuser\%%A\sig&stick\Signatures" /s
echo d | xcopy "C:\Users\%%A\AppData\Local\Packages\Microsoft.MicrosoftStickyNotes_8wekyb3d8bbwe\LocalState\*" "d:\++Bkuser\%%A\sig&stick\stick" /s
echo d | xcopy C:\Users\%%A\AppData\Roaming\SAP\* "d:\++Bkuser\%bkuser%\SAP /s
